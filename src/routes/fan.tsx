...
export const Route = createFileRoute("/fan")({
  head: () => ({ meta: [{ title: "Sochal · For You" }] }),
  component: FanFeed,
});
...
function ConnectGate() {
  return (
    <div className="min-h-screen bg-black flex items-center justify-center px-4">
      <div className="text-center"><div className="text-7xl mb-4">🎤</div><h2 className="text-2xl font-bold text-white mb-2">Sochal</h2><p className="text-gray-400 mb-6">Connect your wallet to watch and create reels</p><Link to="/"><Button className="bg-gradient-primary shadow-glow"><LogIn className="size-4 mr-2" /> Connect Wallet</Button></Link></div>
    </div>
  );
}